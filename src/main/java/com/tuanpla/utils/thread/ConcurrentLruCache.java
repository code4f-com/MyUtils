 ...
 * cached values and a {@code ConcurrentLinkedDeque} for ordering the keys and
...
public class ConcurrentLruCache<K, V> {
     ...
     *
     * @param sizeLimit the maximum number of entries in the cache (0 indicates
     * no caching, always generating a new value)
    ...
    /**
     * Retrieve an entry from the cache, potentially triggering generation of
     * the value.
     *
     ...
     * @return {@code true} if the key is present, {@code false} if there was no
     * matching key
     */
     ...
     * @return {@code true} if the key was present before, {@code false} if
    ...
    /**
     * Return the maximum number of entries in the cache (0 indicates no
     * caching, always generating a new value).
     *
     * @see #size()
     */
