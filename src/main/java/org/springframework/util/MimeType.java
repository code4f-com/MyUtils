 ...
 *
 * <p>
 * Consists of a {@linkplain #getType() type} and a
 * {@linkplain #getSubtype() subtype}. Also has functionality to parse MIME Type
 * values from a {@code String} using {@link #valueOf(String)}. For more parsing
 * options see {@link MimeTypeUtils}.
 *
...
public class MimeType implements Comparable<MimeType>, Serializable {
     ...
     * @throws IllegalArgumentException if any of the parameters contains
     * illegal characters
     */
     ...
     * given {@code MimeType}, skipping checks performed in other constructors.
     *
     * @param other the other MimeType
     * @since 5.3
     */
