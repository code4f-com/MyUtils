 ...
 *
 * <pre class="code">
 * Assert.notNull(clazz, "The class must not be null"); Assert.isTrue(i &gt; 0,
...
public abstract class Assert {
     ...
     * {@code IllegalArgumentException} on an assertion failure.
     * <pre class="code">
     * Assert.state(entity.getId() == null, () -&gt; "ID for entity " +
     * entity.getName() + " must not already be initialized");
     * </pre>
     *
     * @param expression a boolean expression
     ...
     * if the expression evaluates to {@code false}.
     * <pre class="code">
     * Assert.isTrue(i &gt; 0, () -&gt; "The value '" + i + "' must be greater
     * than zero");
     * </pre>
     *
     * @param expression a boolean expression
     ...
     * Assert that an object is not {@code null}.
     * <pre class="code">
     * Assert.notNull(entity.getId(), () -&gt; "ID for entity " +
     * entity.getName() + " must not be null");
     * </pre>
     *
     * @param object the object to check
     * @param messageSupplier a supplier for the exception message to use if the
     ...
     * {@code null} and not the empty String.
     * <pre class="code">
     * Assert.hasLength(account.getName(), () -&gt; "Name for account '" +
     * account.getId() + "' must not be empty");
     * </pre>
     *
     * @param text the String to check
     * @param messageSupplier a supplier for the exception message to use if the
     ...
     * character.
     * <pre class="code">
     * Assert.hasText(account.getName(), () -&gt; "Name for account '" +
     * account.getId() + "' must not be empty");
     * </pre>
     *
     * @param text the String to check
     ...
     * Assert that the given text does not contain the given substring.
     * <pre class="code">
     * Assert.doesNotContain(name, forbidden, () -&gt; "Name must not contain '"
     * + forbidden + "'");
     * </pre>
     *
     * @param textToSearch the text to search
     ...
     * {@code null} and must contain at least one element.
     * <pre class="code">
     * Assert.notEmpty(array, () -&gt; "The " + arrayType + " array must contain
     * elements");
     * </pre>
     *
     * @param array the array to check
     ...
     * Note: Does not complain if the array is empty!
     * <pre class="code">
     * Assert.noNullElements(array, () -&gt; "The " + arrayType + " array must
     ...
     * <pre class="code">Assert.noNullElements(collection, "Collection must
     ...
     * Note: Does not complain if the collection is empty!
     * <pre class="code">
     * Assert.noNullElements(collection, () -&gt; "Collection " + collectionName
     * + " must contain non-null elements");
     * </pre>
     *
     * @param collection the collection to check
     * @param messageSupplier a supplier for the exception message to use if the
     ...
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the map is {@code null} or contains
     * no entries
     */
     ...
     * and must contain at least one entry.
     * <pre class="code">
     * Assert.notEmpty(map, () -&gt; "The " + mapType + " map must contain
     * entries");
     * </pre>
     *
     * @param map the map to check
     ...
     * <pre class="code">Assert.instanceOf(Foo.class, foo, "Foo
     * expected");</pre>
     *
     ...
     * exception message will be appended. If it ends in a space, the name of
     * the offending object's type will be appended. In any other case, a ":"
     ...
     * Assert that the provided object is an instance of the provided class.
     * <pre class="code">
     * Assert.instanceOf(Foo.class, foo, () -&gt; "Processing " +
     ...
     * context. If it is empty or ends in ":" or ";" or "," or ".", a full
     * exception message will be appended. If it ends in a space, the name of
     * the offending sub type will be appended. In any other case, a ":" with a
