...
public class MediaType extends MimeType implements Serializable {
     ...
     * now comply with the specification</a> and interpret correctly UTF-8
     * special characters without requiring a {@code charset=UTF-8} parameter.
     */
    @Deprecated
     ...
     * {@link #APPLICATION_STREAM_JSON_VALUE}.
     */
    @Deprecated
     ...
     * replaced with a different mime type. Use {@link #APPLICATION_NDJSON} as a
     * replacement or any other line-delimited JSON format (e.g. JSON Lines,
     * JSON Text Sequences).
     */
    @Deprecated
     ...
     * subtype and parameters information is copied and
     * {@code MediaType}-specific checks on parameters are performed.
     *
     ...
     * @throws InvalidMediaTypeException if the media type value cannot be
     * parsed
     ...
     * <ol>
     * <li>if either media type has a
     * {@linkplain #isWildcardType() wildcard type}, then the media type without
     ...
     * <li>if either media type has a
     * {@linkplain #isWildcardSubtype() wildcard subtype}, then the media type
     * without the wildcard is sorted before the other.</li>
     * <li>if the two media types have different
     * {@linkplain #getSubtype() subtypes}, then they are considered equal and
     * remain their current order.</li>
     * <li>if the two media types have different
     * {@linkplain #getQualityValue() quality value}, then the media type with
